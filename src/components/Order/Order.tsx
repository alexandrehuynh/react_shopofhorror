...
export const Order = () => {
  ...
  return (
    <Box sx={{ height: 400, width: '100%' }}>
      ...
      />
      <Button variant='outlined' color='info'  sx={{ marginTop: '10px', marginRight: '20px'}} onClick={()=> setDialogOpen(true)}>Update</Button>
      <Button variant='outlined' color='warning' sx={{ marginTop: '10px', marginRight: '20px'}} onClick={deleteItem}>Delete</Button>
